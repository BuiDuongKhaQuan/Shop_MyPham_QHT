...
<body>
<div class="home">
    <a href="home" style="z-index: 100">Về trang chủ</a>
</div>
<div class="main">

    <div class="container b-container" id="b-container">
        <form class="form" id="a-form" method="" action="signup">
            ...
            <input name="user" class="form__input" type="text" placeholder="Tên"/>
            <input name="pass" class="form__input" type="password" placeholder="Mật khẩu"/>
            <input name="re-pass" class="form__input" type="password" placeholder="Nhập lại mật khẩu"/>
            <button type="submit" class="switch__button button">ĐĂNG KÝ</button>
        </form>
    </div>

    <div class="container a-container" id="a-container">
        <form class="form" id="b-form" method="" action="login">
            ...
            <span class="form__span">hoặc sử dụng email để đăng nhập</span>
            <input name="user" class="form__input" type="text" placeholder="Email"/>
            <input name="pass" class="form__input" type="password" placeholder="Mật khẩu"/><a
        ...
        >
            ...
            <%}%>
            <button type="submit" class="switch__button button">ĐĂNG NHẬP</button>
        </form>
    </div>
    ...
    <div class="switch" id="switch-cnt">
        ...
        <div class="switch__container  is-hidden" id="switch-c2">
            <h2 class="switch__title title">Chào mừng bạn đã quay trở lại !</h2>
            <p class="switch__description description">
                Nhập thông tin của bạn và bắt đầu hành trình với chúng tôi
            </p>
