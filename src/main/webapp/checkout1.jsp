            ...
            <div class="col-lg-8">
                ...
                <div class="col-lg-12 mb-5">
                    ...
                    ></textarea>
                        ...
                        <div class="control-group">
                            <h3>Bạn vui lòng đăng nhập để sử dụng chức năng thanh toán</h3>
                        </div>
                ...
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-body">
                        ...
                        <select name="payment" class="custom-select">
                            ...
                            <option selected>Ví điện tử
                            </option>
                            <option selected>Thẻ tính dụng
                            </option>
                            <option selected>Thanh toán trực tiếp khi nhận hàng
                            </option>
                        </select>
                    </div>
                    <div class="card-footer border-secondary bg-transparent">
