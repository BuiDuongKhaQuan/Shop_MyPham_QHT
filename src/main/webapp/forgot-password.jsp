...
<body>
<div class="home">
    <a href="home.jsp" style="z-index: 100">Về trang chủ</a>
</div>
<div class="main">
    <div class="container a-container" id="a-container">
        <form class="form" id="a-form" method="post" action="forgot-password">
            ...
            <span class="form__span">điền thông tin tài khoản của bạn</span>
            <input class="form__input" name="user" type="text" placeholder="Tên đăng nhập"/>
            ...
            <button type="submit" class="switch__button button">XÁC NHẬN</button>
        </form>
    </div>
    ...
    <div class="switch" id="switch-cnt">
        ...
        <!-- Hiển thị khi ở trạng thái đăng ký -->
        <div class="switch__container" id="switch-c1">
            <h2 class="switch__title title">Đừng lo lắng !</h2>
            <p class="switch__description description">
                Hãy để lại thông tin chúng tôi sẻ giúp bạn lấy lại mật khẩu
            </p>
        </div>
    </div>
</div>
